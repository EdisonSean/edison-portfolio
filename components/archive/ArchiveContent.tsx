                ...
                >
                  ...
                  {item.githubUrl ? (
                    <p className="-mt-7 max-w-2xl text-[0.9rem] font-semibold leading-[1.45] md:col-span-2 md:text-[0.98rem]">
                      <a
                        className="inline-flex items-center border border-zinc-700/80 px-3 py-1.5 text-zinc-300 transition-colors duration-200 hover:border-zinc-200 hover:bg-zinc-900/70 hover:text-white"
                        href={item.githubUrl}
                        target="_blank"
                        rel="noreferrer"
                      >
